...
* Team updates (compared to About page, some old news!):
    ...
    - David Meza new member - but what primary team: surveys, on-ramps?
    - Maelle to swap to on-ramps team
    - Liz K joined social media team
    
* R Summit
    - David S, Jonathan G, Di Cook, Julie Josse, John Fox (others?)
    - 30 minute presentation with updates (workshops, surveys) to R Foundation by another member (Heather will be unable to attend) -- perhaps Di or Julie
...
**ACTIONS**
- New email call for About page information and review of team roles -- Heather has had individual conversations with certain members, others who would like to revisit their contributions can reply to email or speak with her in person at useR.
...
- Handling of issues that extend beyond individual conference -- longer term ban on repeat offenders, improvement of reporting mechanisms (i.e. after conference if it was a one-time event)
- In repo on GitHub for discussion, in person conversations at eRum conference -- Julie has already made edits based on feedback
- Current status: JJ look at Python CoC (which was recently reviewed), ISBA policy
- Have any changes been made to JSM after rumblings on Twitter
- Word of caution: this is a policy, not a legally enforceable document -- this is a perception that we need to address because it is barrier to implementation

**ACTIONS**
- Thoughts, comments, and suggestions welcome if people can take a look at Github repo; good conversation to have at R Summit (work out controversial points and pointers for addressing them)
...
**ACTIONS**
- Look into adding prior presentations to website? (May require additional website section -- addition to task repo)

### Surveys
- Preparation for useR! 2018 survey: TA is working with Nujcharee (revision of questions and member of local organizing team is helping with Survey Monkey)
